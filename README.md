...
## Hosted deployment
See [deployment setup](docs/deployment.md) for Netlify/Render settings, required Supabase migration, Cloudinary media, auth redirects and optional health-check schedule. Production now requires Supabase persistence; local JSON remains a development-only mode.
